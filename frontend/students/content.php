            ...
            <header class="bg-white shadow-sm">
                ...
                <div class="px-6 py-2 border-t border-gray-100">
                    <div class="flex items-center text-sm">
                        <a href="#" class="text-gray-500 hover:text-primary">Student</a>
            ...
            <div class="p-6">
               <div class="flex flex-wrap items-center justify-between mb-6">
                    <div class="text-sm text-gray-500">
                        <div class="flex items-center">
                            <h1 class="text-2xl font-semibold text-gray-800">Student</h1>
                        </div>
                    </div>
                    <div class="relative">
                      ...
                      <input type="text" class="bg-gray-50 border border-gray-300 pl-10 pr-4 py-2 rounded-lg text-sm w-64 focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="Search student ID">
                  </div>
                </div>
